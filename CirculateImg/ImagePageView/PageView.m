...
-(void)setUpPageControl:(NSArray *)array
{
    ...
    pageControl.pageIndicatorTintColor = [UIColor blueColor];//pagecotrol颜色
...
- (void)pageViewClick:(UITapGestureRecognizer *)tap
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(didSelectPageViewWithNumber:)]) {
